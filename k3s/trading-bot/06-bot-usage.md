...
<br><br>For whole-cluster wakeup, sleep and health-check, the scripts from `/k3s/scripts/scripts-setup.md` can be used, with the following commands:
```
#Wakeup
bash ~/k3s-cluster/k3s/scripts/wake.sh

#Sleep
bash ~/k3s-cluster/k3s/scripts/sleep.sh
