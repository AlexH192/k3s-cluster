...
* The decision to use K3s for this project was made with the resource constraints of the physical thin clients in mind. Due to their (relatively) low processing power and K3s being the Kubernetes distribution most optimized for such environments, the choice was simple; using a different distribution such as K8s would take up too much storage and processing power while not providing any significant benefit within the scope of this project.
