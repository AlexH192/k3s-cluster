...
<img width="350" height="630" alt="IMG_6842 (1)" src="https://github.com/user-attachments/assets/b9831bb4-49cd-4fa5-a63f-64dee60c89a5" />
...
<br><br>The general architecture diagram is depicted below.
...
└──────────────┘     └──────┬───────┘
 ...
 │ Nginx & dnsmasq│ │ Traefik Router │ │ Trading Pods   │
 │ PXE Boot Host  │ │ Prometheus     │ │ Redis Cache    │
 └────────────────┘ └────────────────┘ └────────────────┘
```
