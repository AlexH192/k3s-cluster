...
<br><br>This project is a three-node Kubernetes cluster built on repurposed enterprise thin clients, featuring automated PXE OS installation & configuration, node and container failovers, external monitoring dashboards and a GitHub Actions CI/CD Pipeline for fast & safe deployment.
